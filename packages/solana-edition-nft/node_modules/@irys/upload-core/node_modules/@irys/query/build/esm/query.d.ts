import { GraphQLQuery } from "@irys/upload-core/node_modules/@irys/query/isomorphic/graphql";
import type { ArweaveBlocks, ArweaveBlocksVars, ArweaveTransactions, ArweaveTransactionsVars, IrysPaymentApprovalVars, IrysPaymentApprovals, IrysTransactionVars, IrysTransactions } from "@irys/upload-core/node_modules/@irys/query/isomorphic/queries/index";
import type { BuilderMethods, QueryCtorOpts, SearchOpts } from "@irys/upload-core/node_modules/@irys/query/isomorphic/types";
export declare class Query {
    ...
    search(queryName: "irys:paymentApprovals", opts?: SearchOpts): BuilderMethods<IrysPaymentApprovalVars, GraphQLQuery<IrysPaymentApprovals, IrysPaymentApprovalVars, IrysPaymentApprovals[]>>;
