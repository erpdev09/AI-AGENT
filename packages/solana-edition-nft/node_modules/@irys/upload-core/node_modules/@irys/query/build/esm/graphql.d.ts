...
import type { ArrayElement, BuilderMethods, Field, Network, QueryInfo, ReturnFields, SearchOpts } from "@irys/upload-core/node_modules/@irys/query/node";
...
export declare class GraphQLQuery<TQuery extends Record<any, any> = any, TVars extends Record<string, any> = any, TReturn extends Record<string, any> = any> {
     ...
     * @returns this (chainable)
     */
    network(network: Network | undefined): BuilderMethods<TVars, GraphQLQuery<TQuery, TVars, TReturn>>;
    /**
     ...
     */
    generator(): AsyncGenerator<Required<ArrayElement<TReturn>>>;
    /**
