...
import type { bundles, Tags, Token, UploadReceipt, UploadReceiptData } from '@irys/upload-core/esm/types';
export declare const sleep: (ms: number) => Promise<void>;
export declare const httpErrData: (res: AxiosResponse) => string;
export declare class Utils {
     ...
     * @returns
     */
    getPrice(token: string, bytes: number, opts?: {
        tags?: Tags;
        address?: string;
    }): Promise<BigNumber>;
    /**
    ...
    static verifyReceipt(dependencies: Pick<bundles, 'stringToBuffer' | 'getCryptoDriver' | 'deepHash'>, receipt: UploadReceiptData): Promise<boolean>;
