import { type Stoppable, type UsesConcurrency } from '@supercharge/promise-pool';
import type { DataItem, JWKInterface } from '@irys/bundles/node';
import type { AxiosResponse } from 'axios';
import type { Readable } from 'stream';
import type Api from '@irys/upload-core/esm/api';
import { ChunkingUploader } from '@irys/upload-core/esm/chunkingUploader';
import { type Token, type bundles, type IrysTransactonCtor, type UploadOptions, type UploadReceipt, type UploadResponse, type CreateAndUploadOptions, type Manifest, type IrysTransaction, type DataItemCreateOptions } from '@irys/upload-core/esm/types';
import type Utils from '@irys/upload-core/esm/utils';
...
export declare class Uploader {
    ...
    createBundle(transactions: (IrysTransaction | DataItem | Buffer)[], opts?: UploadOptions & {
        throwawayKey?: JWKInterface;
        bundleOpts?: DataItemCreateOptions;
    }): Promise<{
        throwawayKey: JWKInterface;
