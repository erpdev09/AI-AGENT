...
import type Irys from '@irys/upload-core/esm/irys';
...
export type IrysTransactonCtor = new (data: string | Uint8Array, Irys: Pick<Irys, 'uploader' | 'tokenConfig' | 'bundles' | 'utils'>, opts?: IrysTransactionCreateOptions) => IrysTransaction;
export type Tx = {
    from: string;
    to: string;
    amount: BigNumber;
