...
import type { WithdrawalResponse } from '@irys/upload-core/esm/types';
/**
 ...
 */
export declare function withdrawBalance(utils: Utils, api: Api, amount: BigNumber.Value | 'all'): Promise<WithdrawalResponse>;
