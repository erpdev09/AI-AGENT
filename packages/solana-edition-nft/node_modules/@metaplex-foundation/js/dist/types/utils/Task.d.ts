import type EventEmitter from '@metaplex-foundation/js/node_modules/eventemitter3';
import { DisposableScope } from './Disposable';
export type TaskStatus = 'pending' | 'running' | 'successful' | 'failed' | 'canceled';
export type TaskCallback<T, I extends any[]> = (scope: DisposableScope, ...inputs: I) => T | Promise<T>;
