...
export declare class AuctionHouseClient {
    ...
    findBidByReceipt(input: FindBidByReceiptInput, options?: OperationOptions): Promise<Readonly<{
        ...
        receiptAddress: import("@metaplex-foundation/js").Option<import("../../types").Pda>;
        ...
        canceledAt: import("@metaplex-foundation/js").Option<import("../../types").DateTime>;
    } & {
        isPublic: false;
    ...
    findBids(input: FindBidsInput, options?: OperationOptions): Promise<import("./operations").FindBidsOutput>;
    ...
    findListings(input: FindListingsInput, options?: OperationOptions): Promise<import("./operations").FindListingsOutput>;
    ...
    findPurchases(input: FindPurchasesInput, options?: OperationOptions): Promise<import("./operations").FindPurchasesOutput>;
