...
import { CandyMachineV2Account, MaybeCandyMachineV2CollectionAccount } from '../accounts';
import { Amount, BigNumber, DateTime, UnparsedAccount, Creator } from '../../../types';
 ...
 * @group Models
 */
export type CandyMachineV2EndSettings = CandyMachineV2EndSettingsAmount | CandyMachineV2EndSettingsDate;
/**
...
/** @group Model Helpers */
export declare function assertCandyMachineV2(value: any): asserts value is CandyMachineV2;
/** @group Model Helpers */
export declare const toCandyMachineV2: (account: CandyMachineV2Account, unparsedAccount: UnparsedAccount, collectionAccount: MaybeCandyMachineV2CollectionAccount | null, mint: Mint | null) => CandyMachineV2;
/**
...
/** @group Model Helpers */
export declare const toCandyMachineV2Configs: (candyMachine: CandyMachineV2) => CandyMachineV2Configs;
/** @group Models */
...
/** @group Model Helpers */
export declare const toCandyMachineV2InstructionData: (address: PublicKey, configs: CandyMachineV2Configs) => CandyMachineV2InstructionData;
