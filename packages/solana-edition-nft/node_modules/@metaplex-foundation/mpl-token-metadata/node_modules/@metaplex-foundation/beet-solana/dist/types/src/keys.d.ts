 ...
 */
export type KeysExports = keyof typeof import('@metaplex-foundation/mpl-token-metadata/node_modules/@metaplex-foundation/beet-solana/dist/types/src/keys');
/**
 * @category TypeDefinition
 */
 ...
 * @category TypeDefinition
 */
export type KeysTypeMap = Record<KeysTypeMapKey, SupportedTypeDefinition & {
    beet: KeysExports;
}>;
/**
