(function (global, factory) {
  ...
  var Getter = function Getter(client) {
    ...
    _defineProperty(this, "do", function () {
      ...
      if (_this.whereString || _this.nearTextString || _this.nearObjectString || _this.nearVectorString || _this.askString || _this.limit || _this.groupString) {
        var args = [];
  ...
  var Explorer = function Explorer(client) {
    ...
    _defineProperty(this, "do", function () {
      ...
      if (_this.askString) {
        args = [].concat(_toConsumableArray(args), ["ask:".concat(_this.nearObjectString)]);
      }
